...
export function Footer() {
  return (
    <footer className="relative border-t border-border/40 bg-background/30 backdrop-blur-xl py-12 overflow-hidden slide-up stagger-2">
      ...
      <div className="container mx-auto px-4 max-w-4xl flex flex-col items-center gap-6 relative z-10">
        ...
        <div className="flex flex-col items-center gap-1.5 text-center fade-in stagger-3">
